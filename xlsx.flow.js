...
/* str.replace(/<!DOCTYPE[^\[]*\[[^\]]*\]>/gm, "") --> remove_doctype(str) */
function remove_doctype(str/*:string*/)/*:string*/ {
...
function str_match_ng(str/*:string*/, s/*:string*/, e/*:string*/)/*:?Array<string>*/ {
	var out/*:Array<string>*/ = [];
...
function str_remove_ng(str/*:string*/, s/*:string*/, e/*:string*/)/*:string*/ {
	var out/*:Array<string>*/ = [], last = 0;
...
function str_match_xml(str/*:string*/, tag/*:string*/)/*:?Array<string>*/ {
...
var str_match_xml_ns = /*#__PURE__*/(function() {
	...
	return function str_match_xml_ns(str/*:string*/, tag/*:string*/)/*:?Array<string>*/ {
...
var str_match_xml_ns_g = /*#__PURE__*/(function() {
	var str_match_xml_ns_cache = {};
	return function str_match_xml_ns_g(str/*:string*/, tag/*:string*/)/*:?Array<string>*/ {
		var out/*:Array<string>*/ = [];
		var res = str_match_xml_ns_cache[tag];
		if(!res) str_match_xml_ns_cache[tag] = res = [
			new RegExp('<(?:\\w+:)?'+tag+'\\b[^<>]*>', "g"),
...
var str_remove_xml_ns_g = /*#__PURE__*/(function() {
	...
	return function str_remove_xml_ns_g(str/*:string*/, tag/*:string*/)/*:string*/ {
		var out/*:Array<string>*/ = [];
		...
		while((m = res[0].exec(str))) {
			...
			res[1].lastIndex = res[0].lastIndex;
			m = res[1].exec(str);
			/* unterminated element -- treat the remainder as text */
			if(!m) { ef = si; break; }
			ef = res[1].lastIndex;
			res[0].lastIndex = res[1].lastIndex;
		}
...
var str_match_xml_ig = /*#__PURE__*/(function() {
	var str_match_xml_ig_cache = {};
	return function str_match_xml_ig(str/*:string*/, tag/*:string*/)/*:?Array<string>*/ {
		var out/*:Array<string>*/ = [];
		var res = str_match_xml_ig_cache[tag];
		if(!res) str_match_xml_ig_cache[tag] = res = [
			new RegExp('<'+tag+'\\b[^<>]*>', "ig"),
			new RegExp('</'+tag+'>', "ig")
		];
		res[0].lastIndex = res[1].lastIndex = 0;
		...
		if(PIDSI) {
			...
			if(Props[i][0] === 0x1) {
				...
				switch(blob[blob.l]) {
					...
					case 0x1E /*VT_LPSTR*/: blob.l += 4; val = parse_VtString(blob, blob[blob.l-4]).replace(/(^|[^\x00])\u0000+$/,"$1"); break;
					case 0x1F /*VT_LPWSTR*/: blob.l += 4; val = parse_VtString(blob, blob[blob.l-4]).replace(/(^|[^\x00])\u0000+$/,"$1"); break;
...
function parse_ws_xml(data/*:?string*/, opts, idx/*:number*/, rels, wb/*:WBWBProps*/, themes, styles)/*:Worksheet*/ {
	...
	if(mtch) {
		/* str_match_xml_ns matches the first open tag, so the literal locates the element */
